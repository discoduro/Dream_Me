...
<body id="container-page-index">
    ...
    <section id="slider-store" class="carousel slide" data-ride="carousel" style="padding: 0;">
        ...
        <div class="carousel-inner" role="listbox">
            ...
            <div class="item">
                <img src="./assets/img/slider3.jpg" alt="slider3" while=300>
                <div class="carousel-caption">
                    Text Slider 3
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6">
                    <img src="assets/img/moda.jpeg" alt="Smart-TV" class="img-responsive" style="width: 70%; display: block; margin: 0 auto;">
                </div>
            </div>
        </div>
    </section>
